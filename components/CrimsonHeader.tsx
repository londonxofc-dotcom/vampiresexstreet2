...
export default function CrimsonHeader() {
  ...
  return (
    <h2
      ref={h2Ref}
      data-crimson-header
      className="mb-8 max-w-full whitespace-nowrap font-sans text-[clamp(2.35rem,10.8vw,4.5rem)] leading-[0.86] tracking-tighter cursor-default select-none sm:max-w-5xl sm:text-7xl md:mb-12 md:text-8xl"
