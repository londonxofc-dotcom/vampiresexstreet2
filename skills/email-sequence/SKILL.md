...
### Email sending (no dedicated platform connected — drafts go to Resend transactional email or hand-off to fan list)
...
### CRM / automation (no platform connected — track manually or via site registry)
